#!/usr/bin/env python3
"""Subprocess worker for the ChatterboxFull TTS engine.
...
def _cmd_generate(req: dict) -> None:
    ...
    conditionals_path: str | None = params.get("conditionals_path")
...
def main() -> None:
    print("chatterbox_full_worker ready", file=sys.stderr, flush=True)
    while True:
        try:
            req = read_request()
